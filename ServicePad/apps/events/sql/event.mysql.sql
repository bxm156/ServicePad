...
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(2, 'Database Tutoring', 'Teach the young about databases', 'Shaker Elementary is looking for someone knowledgable in database design to teach our 1st grade class. The commitment will be one hour every week. All applicants must be good with kids.', '2625 Shaker Rd', 'Cleveland', 'OH', '44118', 1, 7, '2013-02-13 13:30:35', '2013-02-13 14:30:36', '2012-12-09 13:51:04', 3);
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(3, 'Dog Shelter', 'Walk dogs!', 'The Cuyahoga County Animal Shelter needs your help. We have dozens of dogs that need exercise but not enough people to walk them. Donate a few hours of your time and help our dogs get outside and enjoy themselves.', '9500 Sweet Valley Dr.', 'Cleveland', 'OH', '44125', 1, 1, '2013-01-15 10:00:00', '2013-01-15 12:00:00', '2012-12-09 13:58:11', 3);
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(4, 'Wade Lagoon Cleanup', 'Make Cleveland beautiful', 'Come out and help pickup trash to help keep the Wade Lagoon a beautiful part of Cleveland.', 'Martin Luther King Jr Dr & Euclid Ave', 'Cleveland', 'OH', '44106', 1, 6, '2013-05-05 14:00:00', '2013-05-05 16:30:00', '2012-12-09 14:03:44', 3);
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(5, 'Thanksgiving with the Homeless', 'Help those less fortunate on Thanksgiving', 'We need volunteers to help us cook and serve Thanksgiving dinner at the Salvation Army.', '4139 East 93rd Street', 'Cleveland', 'OH', '44105', 1, 3, '2012-11-22 11:00:00', '2012-11-22 13:00:00', '2012-12-09 14:50:13', 3);
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(6, 'Habitat for Humanity', 'Build houses!', 'We need able and helping hands to build homes for those without. No prior building experience needed. We\'ll teach you everything you need to know.', '4000 Euclid Ave', 'Cleveland', 'OH', '44107', 1, 9, '2012-12-01 08:00:00', '2012-12-01 20:00:00', '2012-12-09 14:52:36', 3);
INSERT INTO `events_event` (`id`, `name`, `short_description`, `long_description`, `address`, `city`, `state`, `postalzip`, `public`, `category_id`, `start_time`, `end_time`, `list_date`, `owner_id`)
VALUES
	(7, 'Broadview Game Night', 'Play games with our residents', 'It\'s time for Broadview Multi-Care Center\'s Game Night! Come play games with our residents. Fun will be had by all.', '5520 Broadview Rd', 'Parma', 'OH', '44134', 1, 5, '2013-12-10 17:00:00', '2013-12-10 22:00:00', '2012-12-09 16:04:10', 3);
